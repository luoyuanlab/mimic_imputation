temporalMICEGP <- function(h, m=10, ci.thr=0.2, norm="self", trte="tr", sd=11242015, nimp=30, maxit=5, mincor=0.5, cl=NULL, ncores=10, param=T, fncf='mimicConfig.R', nug_thres=20) { # leave out mtry
